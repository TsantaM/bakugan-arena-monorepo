...
import { GetReplayById } from '@/src/actions/replay/get-replay-by-id'
import { resolveLoadedReplay } from '@/src/lib/replay/resolve-loaded-replay'
...
export default function SelectUploadedReplay({
    ...
    async function handleSelect(replayId: string) {
        ...
        try {
            ...
            const loaded = await resolveLoadedReplay(row)
            setReplay(loaded)
        } catch (error) {
