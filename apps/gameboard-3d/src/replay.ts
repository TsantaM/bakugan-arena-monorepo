...
if (roomId !== null && userId !== null && player1Id !== null) {
  if (canvas) {
    ...
    // RETIRER LE SOCKET HANDLERS POUR UTILISER LE INIT ROOM DIRECTEMENT DEPUIS LE REPLAY.TS
    registerSocketHandlersViewers(socket, {
      camera: camera,
      light: light,
      plane: plane,
      roomId: roomId,
