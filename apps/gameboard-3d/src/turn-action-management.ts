import type { ActionRequestAnswerType, ActionType, SelectableAbilityCardAction, SelectableBakuganAction, SelectableGateCardAction } from "@bakugan-arena/game-data/src/type/actions-serveur-requests";
import { CreateBakuganSelecter, CreateGateCardSelecter } from "./functions/create-selecters";

export function TurnActionBuilder({ actions }: { actions: ActionType[] }) {

    console.log('turn action builder', actions)
