...
import { configureTurnActionBridge, syncTurnCountFromState } from "../turn-action-management/turn-action-bridge"
...
const syncLocalTurnFromState = (state: roomStateType) => {
    ...
    syncTurnCountFromState(state.turnState.turnCount)
}
