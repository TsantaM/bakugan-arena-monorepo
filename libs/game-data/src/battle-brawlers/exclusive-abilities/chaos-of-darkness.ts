...
export const ChaosOfDarkness: exclusiveAbilitiesType = {
    ...
    description: `Adds 100 Gs to the user for the entire duration of the game, as long as the card is not canceled and decrease the selected bakugan's power by 100 Gs.`,
    maxInDeck: 1,
        ...
        if (slotOfGate) {
            ...
            if (user) {
                ...
                const request: AbilityCardsActions = {
                    ...
                    message: 'Chaos of Darkness : Select a Bakugan to target',
                    bakugans: bakugans
                }
