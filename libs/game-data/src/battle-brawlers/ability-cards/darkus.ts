...
export const PoivreDesCayenne: abilityCardsType = {
    ...
    attribut: 'Darkus',
    maxInDeck: 2,
    description: `During battle on the slot where this card is activated, this card subtracts 50 Gs from one opponent Bakugan on that slot. The penalty is reversed if this card is nullified.`,
    image: StandardCardsImages.darkus,
    usable_in_neutral: false,
