...
export const PyrusDarkus: abilityCardsType = {
    ...
    onActivate({ roomState, userId, bakuganKey, slot }) {
        ...
        DiagonalCombinationEffect({ animationsForReplay: roomState.animationsForReplay, animations: roomState.animations, attribut: 'Pyrus', attributWeak: 'Darkus', bakuganKey: bakuganKey, portalSlots: portalSlots, slotOfGate: slotOfGate, userId: userId, turn: roomState.turnState.turnCount })
        return null
    },
...
export const DarkusPyrus: abilityCardsType = {
    ...
    onActivate({ roomState, userId, bakuganKey, slot }) {
        ...
        if (!slotOfGate) return failed
        if (!portalSlots) return failed
        DiagonalCombinationEffect({ animationsForReplay: roomState.animationsForReplay, animations: roomState.animations, attribut: 'Darkus', attributWeak: 'Pyrus', bakuganKey: bakuganKey, portalSlots: portalSlots, slotOfGate: slotOfGate, userId: userId, turn: roomState.turnState.turnCount })
        return null
    },
    activationConditions({ roomState, userId }) {
        if (!roomState) return false
...
export const VentusHaos: abilityCardsType = {
    ...
    onActivate({ roomState, userId, bakuganKey, slot }) {
        ...
        if (!slotOfGate) return failed
        if (!portalSlots) return failed
        DiagonalCombinationEffect({ animationsForReplay: roomState.animationsForReplay, animations: roomState.animations, attribut: 'Ventus', attributWeak: 'Haos', bakuganKey: bakuganKey, portalSlots: portalSlots, slotOfGate: slotOfGate, userId: userId, turn: roomState.turnState.turnCount })
        return null
    },
    activationConditions({ roomState, userId }) {
        if (!roomState) return false
...
export const HaosVentus: abilityCardsType = {
    ...
    onActivate({ roomState, userId, bakuganKey, slot }) {
        ...
        if (!slotOfGate) return failed
        if (!portalSlots) return failed
        DiagonalCombinationEffect({ animationsForReplay: roomState.animationsForReplay, animations: roomState.animations, attribut: 'Haos', attributWeak: 'Ventus', bakuganKey: bakuganKey, portalSlots: portalSlots, slotOfGate: slotOfGate, userId: userId, turn: roomState.turnState.turnCount })
        return null
    },
    activationConditions({ roomState, userId }) {
        if (!roomState) return false
...
export const AquosSubterra: abilityCardsType = {
    ...
    onActivate({ roomState, userId, bakuganKey, slot }) {
        ...
        if (!slotOfGate) return failed
        if (!portalSlots) return failed
        DiagonalCombinationEffect({ animationsForReplay: roomState.animationsForReplay, animations: roomState.animations, attribut: 'Aquos', attributWeak: 'Subterra', bakuganKey: bakuganKey, portalSlots: portalSlots, slotOfGate: slotOfGate, userId: userId, turn: roomState.turnState.turnCount })
        return null
    },
    activationConditions({ roomState, userId }) {
        if (!roomState) return false
...
export const SubterraAquos: abilityCardsType = {
    ...
    onActivate({ roomState, userId, bakuganKey, slot }) {
        ...
        if (!slotOfGate) return failed
        if (!portalSlots) return failed
        DiagonalCombinationEffect({ animationsForReplay: roomState.animationsForReplay, animations: roomState.animations, attribut: 'Subterra', attributWeak: 'Aquos', bakuganKey: bakuganKey, portalSlots: portalSlots, slotOfGate: slotOfGate, userId: userId, turn: roomState.turnState.turnCount })
        return null
    },
    activationConditions({ roomState, userId }) {
        if (!roomState) return false
