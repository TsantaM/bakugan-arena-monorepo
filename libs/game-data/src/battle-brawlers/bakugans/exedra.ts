...
const family: string = "exedra"

export const ExedraDarkus: bakuganType = {
    key: "exedra-darkus",
    attribut: "Darkus",
...
export const ExedraGateCard: gateCardType = {
    ...
    onOpen({ roomState, slot }) {
        const slotOfGate = roomState?.protalSlots.find((s) => s.id === slot && s.portalCard?.key === 'exedra-gate-card')
