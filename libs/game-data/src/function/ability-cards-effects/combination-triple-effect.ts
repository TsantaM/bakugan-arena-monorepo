...
export function CombinationTripleEffect({ animationsForReplay, animations, userId, attribut_one, attribut_tree, attribut_two, portalSlots, turn }: { animationsForReplay: AnimationDirectivesTypes[] , animations: AnimationDirectivesTypes[], userId: string, attribut_one: attribut, attribut_two: attribut, attribut_tree: attribut, portalSlots: portalSlotsType, turn: number }) {
